...
public interface Resolver {
     ...
     * </ul>
     * Generally, {@link org.jboss.fuse.patch.management.PatchKind} determinates what version is more important, but
     * sometimes we want to change this - for example, in case of
     * {@link org.jboss.fuse.patch.management.PatchKind#ROLLUP rollup patches}, we prefer patch' version and conflicting user
