...
@Service
public class JasyptPbeAlgorithmsCompletionSupport implements Completer {

    private static Set<String> supportedAlgorithms = new TreeSet<>();

    public JasyptPbeAlgorithmsCompletionSupport() {
        final Set digestAlgos = AlgorithmRegistry.getAllPBEAlgorithms();
