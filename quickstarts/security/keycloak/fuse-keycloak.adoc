...
[listing,options="nowrap"]
----
karaf@root()> feature:repo-add mvn:org.keycloak/keycloak-osgi-features/4.1.0.Final-SNAPSHOT/xml/features
Adding feature url mvn:org.keycloak/keycloak-osgi-features/4.1.0.Final-SNAPSHOT/xml/features
karaf@root()> feature:install keycloak-pax-http-undertow
----
