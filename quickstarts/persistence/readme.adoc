...
[INFO] Building Red Hat Fuse :: Quickstarts :: persistence :: manual 7.2.0.redhat-SNAPSHOT
[INFO] --------------------------------[ pom ]---------------------------------
[INFO]
...
...
[INFO] Building Red Hat Fuse :: Quickstarts :: persistence :: standalone transaction support 7.2.0.redhat-SNAPSHOT
[INFO] --------------------------------[ jar ]---------------------------------
[INFO]
...
karaf@root()> install -s mvn:org.jboss.fuse.quickstarts/camel-jdbc/7.2.0.redhat-SNAPSHOT
Bundle ID: 238
----
